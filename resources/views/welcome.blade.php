                ...
                <div class="flex-1 flex items-center">
                    <div class="text-center mx-auto">
                        ...
                        <p class="text-title2 text-text mb-7">
                            ...
                            Timur, Indonesia</p>
                        <a href="{{ route('login') }}"
                            class="py-3 px-9 text-title2 text-lwhite rounded-xl hover:bg-blue-700" style="background-color: #FCA311">Mulai Aplikasi
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center sm:pt-4 md:px-0">
                ...
                <div class="order-1 mb-16 md:order-2 w-full md:w-3/5 md:pl-4">
                    ...
                    <p class="text-body text-tblack leading-relaxed mb-12 xl:text-title2">
                        Multipath QUIC (MPQUIC) adalah ekstensi dari protokol Quick UDP Internet Connections (QUIC) yang memperkenalkan kemampuan multipath dalam transmisi data.
                        MPQUIC meningkatkan kemampuan QUIC dengan memungkinkan penggunaan beberapa jalur jaringan secara bersamaan, memungkinkan paket data ditransmisikan melalui berbagai antarmuka jaringan secara paralel.
                    </p>
                    <a href="{{ route('login') }}"
        ...
        <div class="container mx-auto relative z-10">
            <div class="flex flex-col md:flex-row items-center sm:px-4">
                <div class="w-full md:w-1/2 order-1 mt-4">
                    <h2 class="text-h3 font-bold mr-4 mb-4 xl:text-h2" style="color: #001D3D">Tahapan Penelitian MP QUIC</h2>
                ...
                <div class="w-full md:w-1/2 order-2">
                    <p class="text-body text-tblack leading-relaxed md:text-lwhite md:pl-8 xl:text-title2">
                        Kami melakukan tahapan untuk implementasi Multipath QUIC (MPQUIC) melalui tahapan terstruktur. Dimulai dengan analisis kebutuhan jaringan, diikuti oleh perancangan protokol sesuai kondisi operasional. Implementasi dilakukan secara bertahap, dengan integrasi AI untuk optimasi performa, dan diakhiri dengan pengujian untuk memastikan protokol memenuhi standar kecepatan, latensi, dan packet loss. Kami berkomitmen memberikan solusi terbaik untuk optimalisasi jaringan Anda.                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="flex flex-col">
                            <p class="text-title2 text-center  mt-6 font-bold" style="color: #001D3D">Tahap Perencanaan</p>
                            <p class="text-body text-tblack mt-4 leading-relaxed">
                                Penelitian dimulai dengan survei lapangan untuk mengidentifikasi kebutuhan jaringan mitra, berfokus pada kecepatan, delay, latensi, dan packet loss, serta FGD untuk memastikan protokol MPQUIC sesuai kebutuhan industri.                            </p>
                        </div>
                    </div>
                </a>
                {{-- Service 2 --}}
                <a href="https://www.youtube.com/watch?v=rjs8j9z7uIE"
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="flex flex-col">
                            <p class="text-title2 text-center  mt-6 font-bold" style="color: #001D3D">Tahap Perancangan</p>
                            <p class="text-body text-tblack mt-4 leading-relaxed">
                                Setelah data terkumpul, perancangan protokol MPQUIC untuk aplikasi Brotani dimulai, meliputi perangkat keras dan lunak, dengan integrasi AI untuk optimasi data ke cloud serta dukungan jaringan regional.                            </p>
                        </div>
                    </div>
                </a>
                {{-- Service 3 --}}
                <a
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="flex flex-col">
                            <p class="text-title2 text-center mt-6 font-bold" style="color: #001D3D">Tahap Implementasi</p>
                            <p class="text-body text-tblack mt-4 leading-relaxed">
                                Setelah perancangan selesai, implementasi bertahap protokol MPQUIC dimulai di greenhouse mitra dan laboratorium untuk uji fungsionalitas. Selanjutnya, AI ditambahkan untuk optimasi performa, dan implementasi diperluas ke skala regional di Jawa Timur.
                            </p>
                        </div>
                    </div>
                </a>
                ...
                <a
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="flex flex-col">
                            <p class="text-title2 text-center  mt-6 font-bold" style="color: #001D3D">Tahap Pengujian</p>
                            <p class="text-body text-tblack mt-4 leading-relaxed">
                                Pengujian protokol MPQUIC mencakup UAT, White Box, dan Black Box Testing di fasilitas mitra dan laboratorium, dengan fokus pada performa AI serta kecepatan, latensi, dan packet loss sesuai standar internasional.
                            </p>
                        </div>
                    </div>
                </a>
            ...
            <div class="flex flex-col md:flex-row md:space-x-4">
                <div class="flex-1 mb-8 md:mb-0">
                    <a href="#">
                        ...
                        <div class="rounded-xl shadow-sm overflow-hidden">
                            <img src="{{ asset('images/blog/blog1.png') }}"
                                alt="" class="w-full">
                        </div>
                        <div class="p-6">
                            ...
                            <p class="text-title2 font-bold mb-6">Keunggulan Multipath QUIC dalam Mengoptimalkan Performa Jaringan</p>
                            <p class="text-body mb-8">Teknologi Multipath QUIC menghadirkan performa jaringan yang lebih andal dan cepat. Artikel ini mengeksplorasi keunggulan utama dari Multipath QUIC,</p>
                ...
                <div class="flex-1 mb-8 md:mb-0">
                    <a href="#">
                        <div class="rounded-xl mb-6 shadow-lg bg-transparent flex-shrink-0 w-full hover:bg-white transition ease-in-out duration-300 transform hover:scale-105">
                        <div class="rounded-xl shadow-sm overflow-hidden">
                            <img src="{{ asset('images/blog/blog2.png') }}" alt=""
                                class="w-full">
                        </div>
                        <div class="p-6">
                            <div class="flex items-center mb-6">
                            ...
                            <p class="text-title2 font-bold mb-6">Pengenalan Multipath QUIC: Teknologi Baru untuk Konektivitas Lebih Cepat</p>
                            <p class="text-body mb-8">Multipath QUIC adalah pengembangan terbaru dari protokol QUIC yang memungkinkan penggunaan beberapa jalur koneksi dalam satu sesi. </p>
                            <div class="flex items-center">
                                <a href="" class="text-title2 font-bold underline">Baca Selengkapnya</a>
                                <img src="{{ asset('images/blog/arrow.png') }}" class="w-5 h-4 ml-2" alt="">
                            </div>
                ...
                <div class="flex-1 mb-8 md:mb-0">
                    ...
                    <a href="http://">
                        <div class="rounded-xl mb-6 shadow-lg bg-transparent flex-shrink-0 w-full hover:bg-white transition ease-in-out duration-300 transform hover:scale-105">
                            <div class="flex flex-row items-center">
                                <img src="{{ asset('images/blog/blog3.png') }}"
                                ...
                                <div class="mx-3">
                                    ...
                                    <p class="text-body font-bold mt-2">Bagaimana Multipath QUIC Membantu Mengatasi Gangguan Jaringan</p>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="http://" class="">
                        <div class="rounded-xl mb-6 shadow-lg bg-transparent flex-shrink-0 w-full hover:bg-white transition ease-in-out duration-300 transform hover:scale-105">
                            <div class="flex flex-row items-center">
                                <img src="{{ asset('images/blog/blog4.png') }}"
                                    class="rounded-xl w-32 h-28" alt="">
                                <div class="mx-3">
                                    <div class="flex items-center">
                                        <img src="{{ asset('images/blog/clock.png') }}" class="w-4 h-4">
                                    ...
                                    <p class="text-body font-bold mt-2">Studi Kasus Implementasi Multipath QUIC pada Aplikasi Mobile</p>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="">
                        <div class="rounded-xl mb-6 shadow-lg bg-transparent flex-shrink-0 w-full hover:bg-white transition ease-in-out duration-300 transform hover:scale-105">
                            <div class="flex flex-row items-center">
                                <img src="{{ asset('images/blog/blog5.png') }}"
                                    class="rounded-xl w-32 h-28" alt="">
                                <div class="mx-3">
                                    <div class="flex items-center">
                                        <img src="{{ asset('images/blog/clock.png') }}" class="w-4 h-4">
                                    ...
                                    <p class="text-body font-bold mt-2">Masa Depan Multipath QUIC dan Pengaruhnya terhadap Teknologi Jaringan</p>
                                </div>
                            </div>
                        </div>
                    </a>
