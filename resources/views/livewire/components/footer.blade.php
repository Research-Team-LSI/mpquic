<footer class="" style="background-color: #001D3D; background-image: url('{{ asset('images/login/pattern.png') }}');">
    <div class="container w-full ">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Column 1 -->
            <div class="flex flex-col items-center md:items-start">
                <img src="{{ asset('images/login/logo.png') }}" class="w-20 h-15  mt-14 mb-6" alt="Image 1">
                <p class="text-white text-title2 mb-6">MPQUIC (Multipath QUIC) is an extension of the QUIC protocol (Quick UDP Internet Connections) that supports multipath communication.
                </p>
                ...
                <p class="text-white text-title2 mb-8">© MP QUIC 2024</p>
            </div>
            <!-- Column 2 -->
            <div class="flex flex-row md:flex-col items-center md:items-start mx-auto">
                ...
                <ul class="flex flex-row md:flex-col">
                    <li class="text-white text-title2 mb-6 mr-6"><a href="#hero">Beranda</a></li>
                    <li class="text-white text-title2 mb-6 mr-6 "><a href="#about">Tentang</a></li>
                    <li class="text-white text-title2 mb-6 mr-6"><a href="#service">Method</a></li>
                    <li class="text-white text-title2 mb-6 mr-6"><a href="#blog">Blog</a></li>
                </ul>
            </div>
            <!-- Column 3 -->
            <div class="flex flex-col items-center md:items-start">
                ...
                <ul class="">
                    ...
                    <li class="text-white text-title2 mb-6 flex items-center">
                        ...
                        <a href="http://">Jl. Simpang Raya Langsep 20B, Malang, Jawa Timur</a>
                    </li>
                    ...
                    <li class="text-white text-title2 mb-6 flex items-center">
                        ...
                        <a href="tel:085233212596">081231910408</a>
                    </li>
