...
<div class="min-h-screen flex flex-col justify-center items-center pt-6 sm:pt-0" style="background-color: #001D3D; background-image: url('{{ asset('images/login/pattern.png') }}'); background-size: cover; background-repeat: no-repeat; background-position: center;">>
    ...
    <div class="text-center mb-6">
        <a href="/" wire:navigate>
            <img src="{{ asset('images/login/logo.png') }}" class="w-20 h-15 mx-auto">
        </a>
    </div>
        ...
        <div>
            ...
            <form wire:submit.prevent="login" class="max-w-md bg-white mx-auto p-4 shadow-md rounded-lg">
                <div class="text-center mt-4">
                    <img src="{{ asset('images/login/kemendikbud.png') }}" class="w-40 h-15 mx-auto pb-2">

                    <h1 class="text-2xl font-bold text-black">Login</h1>

                    <p class="text-gray-600 mt-2">Selamat datang di Website MP QUIC</p>
                </div>
